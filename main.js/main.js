...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ srollAnimado)\n/* harmony export */ });\nfunction srollAnimado() {\n  var animaSectiosn = document.querySelectorAll('.js-scroll');\n  var metadeTelaMedida = window.innerHeight * 0.5;\n\n  function animaScroll() {\n    animaSectiosn.forEach(function (section) {\n      var sectionsTop = section.getBoundingClientRect().top;\n      var proporcTela = sectionsTop - metadeTelaMedida;\n\n      if (proporcTela < 0) {\n        section.classList.add('js-anima');\n      } else if (section.classList.contains('js-anima')) {\n        section.classList.remove('js-anima');\n      }\n    });\n  }\n\n  animaScroll();\n  window.addEventListener('scroll', animaScroll);\n}\n\n//# sourceURL=webpack://origamid-curos/./js/modules/scroll-animado.js?");
